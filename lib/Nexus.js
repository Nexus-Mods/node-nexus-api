...
class Nexus {
    constructor(game, apiKey, appVersion, timeout) {
    ...
    setKey(apiKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (apiKey !== undefined) {
                try {
                    const res = yield this.validateKey(apiKey);
    ...
    getDownloadURLs(modId, fileId, key, expires, gameId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.mQuota.wait();
            return this.request(this.mBaseURL + '/games/{gameId}/mods/{modId}/files/{fileId}/download_link?key={key}&expires={expires}', this.args({ path: this.filter({ modId, fileId, gameId, key, expires }) }));
        });
    }
    getOwnIssues() {
        return __awaiter(this, void 0, void 0, function* () {
