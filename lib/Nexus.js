...
class Nexus {
    ...
    searchCollectionsGraph(query, options) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.mQuota.wait();
            const { gameId, count = 20, offset = 0, sort = { field: 'endorsements', direction: 'DESC' }, search, categoryName, collectionStatuses = ['listed', 'published', 'under_moderation', 'unlisted'], includeAdultContent = true, } = options;
            const sortParam = {};
