...
class Nexus {
    ...
    createCollection(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            }, { collectionData: data }, this.args({ path: this.filter({}) }), ['collectionId', 'revisionId', 'success']);
        });
    }
    updateCollection(data, collectionId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            }, { collectionData: data, collectionId }, this.args({ path: this.filter({}) }), ['collectionId', 'revisionId', 'success']);
        });
    }
