...
function handleRestResult(resolve, reject, url, error, response, body, onUpdateLimit) {
    ...
    if (error !== null) {
        try {
            ...
            if (message) {
                return reject(new customErrors_1.NexusError(translateMessage(message), response.statusCode, url, message));
            }
        }
        catch (_e) {
        }
...
class Nexus {
    ...
    getFileInfo(modId, fileId, gameId) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            if (((_b = (_a = this.mBaseData) === null || _a === void 0 ? void 0 : _a.headers) === null || _b === void 0 ? void 0 : _b['APIKEY']) === undefined) {
