...
class Nexus {
    constructor(appName, appVersion, defaultGame, timeout) {
        ...
        this.mQuota = new Quota_1.default(param.QUOTA_MAX, param.QUOTA_MAX, param.QUOTA_RATE_MS, this.mBaseData.requestConfig.timeout);
    }
    ...
    modsByUid(query, uids, count) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const chunk of chunkify(uids, chunkSize)) {
                ...
                res.push(...(yield this.requestGraph('modsByUid', parameters, { nodes: query }, { uids: chunk, count: chunkCount }, this.args({ path: this.filter({}) }))).nodes);
            }
            return res;
        });
    }
    ...
    genError(input, query) {
        var _a, _b;
        const errors = Array.isArray(input) ? input : [];
        const message = errors.map(err => err.message).join(', ');
        const codeEntry = errors.find(iter => { var _a; return ((_a = iter.extensions) === null || _a === void 0 ? void 0 : _a.code) !== undefined; });
        const code = (_a = codeEntry === null || codeEntry === void 0 ? void 0 : codeEntry.extensions) === null || _a === void 0 ? void 0 : _a.code;
        const rawDetail = (_b = codeEntry === null || codeEntry === void 0 ? void 0 : codeEntry.extensions) === null || _b === void 0 ? void 0 : _b.detail;
        const details = (Array.isArray(rawDetail) ? rawDetail : []).map(this.convertErrDetail);
        ...
        return new customErrors_1.GraphError(message, code, details, entries, query);
    }
    requestGraph(root, parameters, query, variables, args) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryStr = this.makeQuery(root, parameters, query, variables);
    ...
    mutateGraph(name, parameters, data, args, retValues) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const queryStr = this.makeMutation(name, parameters, retValues);
    ...
    isRefreshTokenUrl(targetUrl) {
        return targetUrl.startsWith(`${param.USER_SERVICE_API_URL}/oauth/token`);
    }
    isTokenExpiringSoon(leewayMs = param.JWT_REFRESH_LEEWAY_MS) {
        var _a;
        if (((_a = this.mOAuthCredentials) === null || _a === void 0 ? void 0 : _a.token) === undefined) {
            return false;
        }
        try {
            const decoded = jwt.decode(this.mOAuthCredentials.token);
            if (typeof (decoded === null || decoded === void 0 ? void 0 : decoded.exp) !== 'number') {
                return false;
            }
    ...
    ensureFreshToken() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.mLogCB('info', 'proactive JWT refresh failed', { message: err === null || err === void 0 ? void 0 : err.message });
            }
        });
    }
    handleJwtRefresh() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.mJwtRefreshPromise = this.doJwtRefresh().then((creds) => { clear(); return creds; }, (err) => { clear(); throw err; });
            return this.mJwtRefreshPromise;
        });
    }
    doJwtRefresh() {
