...
class Nexus {
    ...
    genError(input, query) {
        ...
        const codeEntry = input.find(iter => { var _a; return ((_a = iter.extensions) === null || _a === void 0 ? void 0 : _a.code) !== undefined; });
        const code = (_a = codeEntry === null || codeEntry === void 0 ? void 0 : codeEntry.extensions) === null || _a === void 0 ? void 0 : _a.code;
        const details = ((_c = (_b = codeEntry === null || codeEntry === void 0 ? void 0 : codeEntry.extensions) === null || _b === void 0 ? void 0 : _b.detail) !== null && _c !== void 0 ? _c : []).map(this.convertErrDetail);
        const entries = input.map(err => {
            var _a;
            return ({
                message: err.message,
                path: err.path,
