...
class Nexus {
    ...
    setOnNewOAuthCredentialsHandler(handler) {
    ...
    request(url, args, method) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (err instanceof customErrors_1.JwtExpiredError && this.jwtRefreshTries < param.MAX_JWT_REFRESH_TRIES) {
