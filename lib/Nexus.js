...
function restGet(inputUrl, args, onUpdateLimit) {
    return new Promise((resolve, reject) => {
        ...
        const req = lib(inputUrl).get(Object.assign(Object.assign({}, url.parse(finalURL)), { headers: args.headers, timeout: args.requestConfig.timeout }), (res) => {
            ...
            if (err !== undefined) {
                res.resume();
                return reject(new customErrors_1.HTTPError(statusCode, err, ''));
            }
...
class Nexus {
    ...
    modsByUid(query, uids) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.mQuota.wait();
            const res = yield this.requestGraph('modsByUid', {
                uids: { type: '[ID!]', optional: false },
            }, { nodes: query }, { uids }, this.args({ path: this.filter({}) }));
            return res.nodes;
        });
    }
    modFilesByUid(query, uids) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.mQuota.wait();
            const res = yield this.requestGraph('modFilesByUid', {
                uids: { type: '[ID!]', optional: false },
            }, { nodes: query }, { uids }, this.args({ path: this.filter({}) }));
            return res.nodes;
        });
    ...
    fileHashes(query, md5Hashes) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.mQuota.wait();
            return yield this.requestGraphWithErrors('fileHashes', {
                md5s: { type: '[String!]', optional: false },
            }, query, { md5s: md5Hashes }, this.args({ path: this.filter({}) }));
        });
    }
    ...
    createCollection(data, assetFileUUID) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.mQuota.wait();
            ...
            }, { collectionData: data, uuid: assetFileUUID }, this.args({ path: this.filter({}) }), ['collectionId', 'revisionId', 'success']);
        });
    }
    updateCollection(data, assetFileUUID, collectionId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.mQuota.wait();
            ...
            }, { collectionData: data, uuid: assetFileUUID, collectionId }, this.args({ path: this.filter({}) }), ['collectionId', 'revisionId', 'revisionNumber', 'success']);
        });
    }
    createOrUpdateRevision(data, assetFileUUID, collectionId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.mQuota.wait();
    ...
    editCollection(collectionId, name, summary, description, category) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            }, { collectionId, name, summary, description, category }, this.args({ path: this.filter({}) }), ['success'])).success;
        });
    }
    publishRevision(revisionId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            }, { revisionId }, this.args({ path: this.filter({}) }), ['success'])).success;
        });
    }
    attachCollectionsToCategory(categoryId, collectionIds) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            }, { id: categoryId, collectionIds }, this.args({ path: this.filter({}) }), ['success'])).success;
        });
    }
    ...
    getCollectionGraph(query, slug) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.mQuota.wait();
            const res = yield this.requestGraph('collection', {
                slug: { type: 'String', optional: false },
            }, query, { slug }, this.args({ path: this.filter({}) }));
            return res;
        });
    }
    ...
    getCollectionRevisionGraph(query, collectionSlug, revisionNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.mQuota.wait();
            const queryUpdated = Object.assign({}, query);
            queryUpdated[`currentRevision(revision: ${revisionNumber})`] = queryUpdated.revision;
            delete queryUpdated.revision;
            const res = yield this.requestGraph('collectionRevision', {
                slug: { type: 'String', optional: false },
            }, query, { slug: collectionSlug }, this.args({ path: this.filter({}) }));
            return res;
        });
    }
