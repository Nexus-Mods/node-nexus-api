...
declare class Nexus {
    ...
    modsByUid(query: graphQL.IModQuery, uids: number[]): Promise<Partial<types.IMod>[]>;
    modFilesByUid(query: graphQL.IModFileQuery, uids: number[]): Promise<Partial<types.IModFile>[]>;
